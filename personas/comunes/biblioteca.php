...
function conectaDb()
{
    ...
    try {
        $tmp = new PDO("mysql:host=localhost;dbname=dbpersonas;charset=utf8mb4", "root", "root");
       return $tmp;
...
function borraTodo()
{
    ...
    $consulta = "DROP DATABASE IF EXISTS dbpersonas";
    ...
    $consulta = "CREATE DATABASE dbpersonas
